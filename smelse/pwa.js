...
const staticCacheName = "smelse-diploma-0.1";

// Installation event
self.addEventListener("install", event => {
    console && console.log("%csmelse-diploma", "color:purple", "Installing app version 0.1...");
});
            ...
            event.respondWith(
                (async () => {
                    try {
                        ...
                        console && console.log("%csmelse-diploma", "color:purple", "Offline", error);
                    }
                })()
            );
        } else {
                ...
                caches.match(event.request).then(response => {
                    ...
                    var cacheBuster =
                        ...
                        ("markjivko.com" === pathUrl.hostname &&
                            pathUrl.pathname.match(/\.(?:ico|png|gif|jpe?g|txt|json|woff2)$/gi));
                    ...
                    return fetch(event.request, {
                        ...
                        return caches.open(staticCacheName).then(cache => {
                            console && console.log("%csmelse-diploma", "color:purple", "DLC " + event.request.url);
...
self.addEventListener("activate", event => {
    console && console.log("%csmelse-diploma", "color:purple", "Activating app version 0.1...");
