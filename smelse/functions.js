document.addEventListener("DOMContentLoaded", function () {
    ...
    const getPath = relativePath => {
        ...
        return window.location.origin + "/smelse/" + (relativePath ? relativePath : "");
    };
    ...
    download.addEventListener("click", e => {
        ...
        anchor.download = "Smelse-Diploma";
        anchor.click();
        anchor.remove();
    });
    ...
    if (canvas.getContext) {
        ...
        (async () => {
            ...
            textarea.addEventListener("keyup", () => {
                ...
                ctx.drawImage(background, -500, -560);
                ctx.drawImage(banner, 60, 50);
