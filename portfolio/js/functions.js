        ...
        var global = {
            ...
            methods: {
                ...
                initHtml: () => {
                    ...
                    $("body").attr(
                        "data-theme",
                        options.themes["undefined" === typeof localStorage.themeId ? 0 : localStorage.themeId]
                    );
                    ...
                    global.objects.banner.html(
                        $(
                            ...
                            <a class="button" target="_blank" rel="noreferrer nofollow" href="${options.authorCta}">Let's talk</a>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="50">
                                <path fill="#f6f6f6" d="M430.1 347.9c-6.6-6.1-16.3-7.6-24.6-9-11.5-1.9-15.9-4-22.6-10-14.3-12.7-14.3-31.1 0-43.8l30.3-26.9c46.4-41 46.4-108.2 0-149.2-34.2-30.1-80.1-45-127.8-45-55.7 0-113.9 20.3-158.8 60.1-83.5 73.8-83.5 194.7 0 268.5 41.5 36.7 97.5 55 152.9 55.4h1.7c55.4 0 110-17.9 148.8-52.4 14.4-12.7 12-36.6.1-47.7zM120 216c0-17.7 14.3-32 32-32s32 14.3 32 32-14.3 32-32 32-32-14.3-32-32zm40 126c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm64-161c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm72 219c-26.5 0-48-21.5-48-48s21.5-48 48-48 48 21.5 48 48-21.5 48-48 48zm24-208c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32z"/>
                            </svg>
                        </div>`
                        ).click(() => {
                    ...
                    $('[data-role="level-up"]').html(
                        `<div style="height:${
                            $("[data-frame].project").length * options.frameHeight + 100
                        }vh;"><span></span></div>`
                    );
                    global.objects.levelUp = $('[data-role="level-up"]').find("span");
                    global.objects.howlerButton = $(`<svg viewBox="0 0 128 128" width="50" xmlns="http://www.w3.org/2000/svg">
                ...
                yearsStop: () => {
                    if (null !== global.timers.years) {
                        ...
                        global.objects.years.html(
                            `<span>${new Date().getFullYear() - (isNaN(startYear) ? options.startYear : startYear)}</span>`
                        );
                    }
                },
                levelUp: (area, append) => {
                    if ("undefined" !== typeof options.areas[area]) {
                        ...
                        var getCoord = {
                            x: () => {
                                var m,
                                    n,
                                    seed = Math.round(1.5 * Math.floor(Math.random() * 80) + 10);
                                seed > 90 && (seed = 90);
                        ...
                        if (append) {
                            ...
                            do {
                                ...
                                if (
                                    area === global.objects.levelUpCache.coords[coordKey].area &&
                ...
                projectPrepare: frame => {
                    ...
                    if ("undefined" === typeof global.objects.projects[projectKey]) {
                        ...
                        global.objects.projects[projectKey].data(
                            "desc",
                            projectParagraph.length ? projectParagraph.html() : "..."
                        );
                        projectParagraph.length && projectParagraph.remove();

                        // Year
                        global.objects.projectYears[projectKey] = $(
                            `<div data-role="p-year"><div>${projectData.year}</div></div>`
                        );
                        global.objects.projects[projectKey].parents("section").append(global.objects.projectYears[projectKey]);
                        ...
                        global.objects.projects[projectKey].append(
                            '<div data-role="p-action">' +
                                (projectData.urlSource.length
                                    ? `<a target="_blank" rel="noreferrer nofollow" href="${projectData.urlSource}">${projectData.labelSource}</a>`
                                    : "") +
                                (projectData.urlDemo.length
                                    ? `<a target="_blank" rel="noreferrer nofollow" href="${projectData.urlDemo}">${projectData.labelDemo}</a>`
                                    : "") +
                                "</div>"
                        );
                ...
                projectShowInfo: (frame, item) => {
                    ...
                    global.objects.projects[projectKey]
                        .find('[data-role="p-title"] > span')
                        .html(
                            "undefined" === typeof item
                                ? `- ${projectYear} -`
                                : `<i>${item.text()} ${
                                      "undefined" !== typeof options.areas[itemArea] ? ` (${options.areas[itemArea]})</i>` : ""
                                  }`
                        );
                    global.objects.projects[projectKey]
                        .find('[data-role="p-desc"]')
                        .html("undefined" === typeof item ? global.objects.projects[projectKey].data("desc") : item.data("desc"));
                ...
                projectRun: (frame, coords) => {
                    ...
                    if ("undefined" !== typeof global.objects.projects[projectKey]) {
                        if (coords.frameTop <= 0) {
                            ...
                            var space =
                                ((coords.frameHeight * 3) / 4 - global.objects.projectToolCount[projectKey] * options.itemWidth) /
                                (global.objects.projectToolCount[projectKey] + 1);
                            ...
                            if (itemId >= 0 && itemId <= global.objects.projectToolCount[projectKey]) {
                                if (
                                    "undefined" === typeof global.objects.projectToolLastId[projectKey] ||
