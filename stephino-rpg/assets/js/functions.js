...
(function ($) {
    ...
    $(document).ready(function () {
        window.setTimeout(function () {
            ...
            window.setTimeout(() => {
                historySlider.owlCarousel({
                    ...
                    center: true,
                    navText: [
                        '<span class="feat-prev"><i class="flaticon-left"></i></span>',
                        '<span class="feat-next"><i class="flaticon-right"></i></span>'
                    ],
                    responsive: {
                        0: {
                            items: 1
        ...
        $(window).on("scroll", function () {
            ...
            scrollTopPx < 500 ? scrollTopButton.removeClass("active") : scrollTopButton.addClass("active");

            scrollTopPx < 1 ? headerSection.removeClass("active") : headerSection.addClass("active");
        });
        ...
        var pwa = function () {
            var getPath = relativePath => {
                ...
                return `${window.location.href.replace(/(?:\/index.html|\/)$/gi, "")}/${relativePath || ""}`;
            };
