        ...
        if($(window).scrollTop() >= submenuPosition.top) {
            ...
            if(!shifting) {
                if($(window).scrollTop()>=framework.top){
                    $('.submenu ul li').removeClass('current');$('.submenu ul li.framework').addClass('current');
                }
                
                if($(window).scrollTop()>=task.top){
                    $('.submenu ul li').removeClass('current');$('.submenu ul li.task').addClass('current');
                }
                if($(window).scrollTop()>=cms.top){
                    $('.submenu ul li').removeClass('current');$('.submenu ul li.cms').addClass('current');
                }
